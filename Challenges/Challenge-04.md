...
- Copy [.gitignore](../Files/.gitignore) to the root folder of your repo. That that will ignore all unnecessary or sensitive files to be commited to the repository.
